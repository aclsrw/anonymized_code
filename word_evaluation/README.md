...
Run the script ```algo.py``` (embedding file location is hardcoded as of now) to reproduce the results on the dimensiolaity reduction algorithm and its evaluation. 
